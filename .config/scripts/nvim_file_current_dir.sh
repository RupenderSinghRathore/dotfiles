...
file=$(find -type d \( -name '.git' -o -name 'themes' -o -name '.venv' -o -name 'node_modules' -o -name '.gradle' -o -name 'META-INF' -o -name '.cache' -o -name 'env' -o -name 'target' -o -name 'tmp' \) -prune \
    -o \
