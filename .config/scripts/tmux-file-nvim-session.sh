...
file=$(find "${search_dirs[@]}" -type d \
    \( -name '.git' -o -name 'themes' -o -name '.venv' -o -name 'node_modules' -o -name 'env' -o -name 'venv' -o -name '.gradle' -o -name 'META-INF' -o -name 'target' -o -name '.cache' -o -name 'utils' -o -name 'CTFd' -o -name 'javascript-exercises' -o -name 'css-exercises' -o -name 'rustlings' \) -prune \
    -o \
