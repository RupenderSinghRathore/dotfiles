...
(let* ((bg "#17120f")
      ...
      (on-secondary "#412c18")
      (on-secondary-container "#ffdcbf")
      (on-surface "#ece0d9")
      (on-surface-variant "#d5c3b6")
      (on-tertiary "#2c340f")
      (on-tertiary-container "#dde8b3")
      (outline-color "#9e8e81")
      (outline-variant "#51443a")
      (primary "#ffb874")
      (primary-container "#6b3b00")
      (secondary "#e2c0a4")
      (secondary-container "#59422d")
      (shadow "#000000")
      (surface "#17120f")
      ...
      (tertiary "#c1cc99")
      (tertiary-container "#424a23")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#c1cc99")
      (on-success "#2c340f")
      (success-container "#424a23")
      (on-success-container "#dde8b3")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb874")
      (primary-fixed-dim "#6b3b00")
      (secondary-fixed "#e2c0a4")
      (secondary-fixed-dim "#59422d")
      (tertiary-fixed "#c1cc99")
      (tertiary-fixed-dim "#424a23")
      (on-primary-fixed "#4b2800")
      (on-primary-fixed-variant "#ffdcbf")
      (on-secondary-fixed "#412c18")
      (on-secondary-fixed-variant "#ffdcbf")
      (on-tertiary-fixed "#2c340f")
      (on-tertiary-fixed-variant "#dde8b3")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ece0d9")
      (inverse-primary "#ffb874")
      (inverse-surface "#17120f")
